    ...
    override func viewDidLoad() {
       ...
       var demoFeature = DemoFeature.init(
            name: NSLocalizedString("Conversational Bots",
                                    comment: "Chat bot, voice control."),
        ...
        /*demoFeature = DemoFeature.init(
            name: NSLocalizedString("Chat Bots",
                                    comment: "Chat bot."),
            detail: NSLocalizedString("Understand user intent and trigger business workflows using voice and chat interfaces.",
                                      comment: "Chat bot."),
            icon: "BotsIcon", storyboard: "BotTextChat")
        
        demoFeatures.append(demoFeature)
        
        // voice bot
        demoFeature = DemoFeature.init(
            name: NSLocalizedString("Voice Bots",
                                    comment: "Voice bot."),
            detail: NSLocalizedString("Understand user intent and trigger business workflows using voice and chat interfaces.",
                                      comment: "Voice bot."),
            icon: "BotsIcon", storyboard: "BotVoiceChat")
